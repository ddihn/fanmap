...
function Membership() {
  ...
  return (
    <div className={M.form}>
      ...
      <div className={M["agreement-wrapper"]}>
        <div className={M["agreement-title"]}>이용약관 동의</div>
        <div className={M.agreement}>
          ...
          />
          <span className={M.checkbox_icon}></span>
      ...
      <div className={M["complete-btn"]} onClick={handleComplete}>
        <span className={M["complete-cmt"]}>회원가입 완료</span>
      </div>
    </div>
  );
}
